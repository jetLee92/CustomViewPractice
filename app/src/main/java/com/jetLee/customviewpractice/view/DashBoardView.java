...
public class DashBoardView extends View {
	...
	private static int INDICATOR_LENGHT = Utils.dpToPx(80);
...
//				90 + ANGLE / 2, 360 - ANGLE, false, paint);
		...
		double indicatorAngle = (360 - ANGLE) / 20 * 1 - (90 + ANGLE / 2);
		indicatorPath.moveTo(getWidth() / 2, getHeight() / 2);
		indicatorPath.rLineTo((float) Math.sin(indicatorAngle) * INDICATOR_LENGHT, (float) Math.sin(indicatorAngle) * INDICATOR_LENGHT);
